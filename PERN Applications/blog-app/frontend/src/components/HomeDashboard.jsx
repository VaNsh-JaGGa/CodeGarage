    ...
    useEffect(() => {
        const loadBlogs = async () => {
            try {
                ...
                console.log("i am stats presenttt");
                            ...
                            <article key={item.id} className="overflow-hidden rounded-[1.6rem] border border-[rgba(93,64,55,0.12)] bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(250,245,239,0.92))] shadow-[0_14px_40px_rgba(46,25,20,0.08)] transition duration-300 hover:-translate-y-1">
                                ...
                                <div className="flex min-h-[15rem] flex-col gap-4 p-6">
                                    ...
                                    <div className="flex flex-wrap items-center gap-3 text-sm">
                                        <div className="inline-flex items-center gap-2 rounded-full border border-[rgba(93,64,55,0.14)] bg-white/80 px-3 py-1.5 text-[#241916]">
                                            <span className="font-semibold">{item.likeCount}</span>
                                            <span className="text-[#6d5b56]">Likes</span>
                                        </div>

                                        <div className="inline-flex items-center gap-2 rounded-full border border-[rgba(93,64,55,0.14)] bg-white/80 px-3 py-1.5 text-[#241916]">
                                            <span className="font-semibold">{item.dislikeCount}</span>
                                            <span className="text-[#6d5b56]">Dislikes</span>
                                        </div>
                                    </div>
