...
const Login = () => {
  ...
  async function submitButton(e) {
    ...
    try {
      ...
      navi("/homedashboard", { replace: true });
    } catch {
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full rounded-2xl border bg-white/90 px-4 py-3.5 pr-20 outline-none transition focus:border-[rgba(184,92,56,0.5)] focus:ring-4 focus:ring-[rgba(184,92,56,0.12)] ${Errors.Password ? "border-red-400 ring-4 ring-red-100" : "border-[rgba(93,64,55,0.12)]"}`}
                value={form.Password}
                onChange={(e) => HandleOnChange(e)}
              />
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 text-sm font-semibold text-[#8e4427]"
              >
