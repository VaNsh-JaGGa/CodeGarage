...
const Password = (props) => {
  ...
  const isInvalidPattern = !passwordValidation.test(
    props.formData.passwordValue,
  );

  return (
    <div className="relative h-[50px] mb-[20px]">
      <label htmlFor="pp" className="absolute top-[-25px] text-sm font-medium ">
        Password
      </label>
      ...
      <label
        ...
        className={`absolute left-3 px-1 transition-all pointer-events-none 
                ${props.errors.passwordValue ? "text-red-500" : "text-gray-500"}
